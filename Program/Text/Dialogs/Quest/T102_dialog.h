string DLG_TEXT_Q [27] = {
	...
	"Yes, unit '",
	"Ã¿, you are correct. My time is coming to an end - the reserve battery is running low. The mission is impossible. The target was not found. Genetic analysis found no close relatives in the given area.",
