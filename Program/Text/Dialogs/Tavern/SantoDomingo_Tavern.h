string DLG_TEXT_TV [24] = {
	...
	"Yeah, well...",
	"Ask your questions, Se単or.",
	"I heard that you recently managed to capture the pirate, Rock the Brazilian himself!",
	"Indeed, it's true. I must tell you it was unprecedented luck, Se単or.",
	...
	"Oh no, Se単or. He was brought here and shown to everyone. Only then was he handed over to the holy fathers...",
	"And why did the holy fathers need him?",
	"Ha, Se単or, they weren't confessors. The holy fathers are warrior monks! The Inquisition...",
