string DLG_TEXT_MR [40] = {
	...
	"Se単or, I've arrived here to carry out an order to defend Maracaibo from external threats. I am sent into your service by Governor Francisco Oregon y Gascon of Havana.",
	...
	"Certainly, Captain. It was brought to my attention that at their latest concourse, the English bandits decided to capture Maracaibo. Although my sources cannot be fully trusted, I thought it would be prudent to request help from Se単or Francisco Oregon y Gascon.",
